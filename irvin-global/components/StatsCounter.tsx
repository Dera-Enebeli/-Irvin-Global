...
export default function StatsCounter() {
  ...
  return (
    <section id="stats" className="py-20 lg:py-28 bg-navy relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <p className="text-gold font-semibold text-sm uppercase tracking-wider mb-3">Our Impact</p>
          <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6">
            Numbers That Speak for Themselves
          </h2>
          <p className="text-white/70 text-lg">
            A decade of trusted service has enabled us to build a robust network and serve 
            thousands of clients across Nigeria.
          </p>
        </div>
